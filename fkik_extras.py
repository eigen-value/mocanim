...
# 
#         
#         controls = ['thigh_ik.L', 'thigh_fk.L', 'shin_fk.L', 'foot_fk.L', 'toe.L', 'foot_heel_ik.L', 'foot_ik.L', 'MCH-foot_fk.L']
#         tweaks   = ['thigh_tweak.L.001', 'shin_tweak.L', 'shin_tweak.L.001']
#         ik_ctrl  = ['foot_ik.L', 'MCH-thigh_ik.L', 'MCH-thigh_ik_target.L']
#         fk_ctrl  = 'thigh_fk.L'
#         parent   = 'MCH-thigh_parent.L'
#         
#         # IK/FK Switch on all Control Bones
#         if is_selected( controls ):
#             layout.prop( pose_bones[ parent ], '["IK/FK"]', slider = True )
...
#             layout.prop( pose_bones[ parent ], '["IK_Strertch"]', slider = True )
#             
#         # FK limb follow
...
# 
#         
#         controls = ['thigh_ik.R', 'thigh_fk.R', 'shin_fk.R', 'foot_fk.R', 'toe.R', 'foot_heel_ik.R', 'foot_ik.R', 'MCH-foot_fk.R']
#         tweaks   = ['thigh_tweak.R.001', 'shin_tweak.R', 'shin_tweak.R.001']
#         ik_ctrl  = ['foot_ik.R', 'MCH-thigh_ik.R', 'MCH-thigh_ik_target.R']
#         fk_ctrl  = 'thigh_fk.R'
#         parent   = 'MCH-thigh_parent.R'
#         
#         # IK/FK Switch on all Control Bones
#         if is_selected( controls ):
#             layout.prop( pose_bones[ parent ], '["IK/FK"]', slider = True )
...
# 
#         
#         controls = ['upper_arm_ik.R', 'upper_arm_fk.R', 'forearm_fk.R', 'hand_fk.R', 'hand_ik.R', 'MCH-hand_fk.R']
